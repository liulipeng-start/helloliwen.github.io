---
title: 深入浅出 TCP/IP 协议栈
categories: 网络
abbrlink: 3f8cb005
date: 2019-06-26 15:58:58
tags:
keywords:
description:
---

　　TCP/IP 协议栈是一系列网络协议的总和，是构成网络通信的核心骨架，它定义了电子设备如何连入因特网，以及数据如何在它们之间进行传输。TCP/IP 协议采用4层结构，分别是**应用层、传输层、网络层**和**链路层**，每一层都呼叫它的下一层所提供的协议来完成自己的需求。由于我们大部分时间都工作在应用层，下层的事情不用我们操心；其次网络协议体系本身就很复杂庞大，入门门槛高，因此很难搞清楚TCP/IP的工作原理，通俗一点讲就是，**一个主机的数据要经过哪些过程才能发送到对方的主机上**。 接下来，我们就来探索一下这个过程。
...
![](http://ww1.sinaimg.cn/large/75a4a8eegy1g4ffuugdl2j20i00f6t9b.jpg)
...
![](http://ww1.sinaimg.cn/large/75a4a8eegy1g4ffvlsomgj20ft02amx0.jpg)
...
![](http://ww1.sinaimg.cn/large/75a4a8eegy1g4ffvz7iuzj20ft02c0sk.jpg)
...
![](http://ww1.sinaimg.cn/large/75a4a8eegy1g4ffw6wf9bj20ft02d0sk.jpg)
...
![](http://ww1.sinaimg.cn/large/75a4a8eegy1g4ffwf3zxtj20zk0ruaiq.jpg)
...
原创发布  @[一像素](http://www.cnblogs.com/onepixel/p/7092302.html)  2017.06.29
...
[1] [互联网协议入门（一）](http://www.ruanyifeng.com/blog/2012/05/internet_protocol_suite_part_i.html)

[2] [TCP/IP协议知识科普](http://www.cnblogs.com/xuanku/p/tcpip.html)
